...
---
# White Balance
<img src="images//photo-white-01.jpeg" style="float:right;width:230px;" alt=picture of a plate white balance>
...
### For the activity:
<img src="images//photo-white-02.jpeg" style="float:right;width:180px;" alt=white plate example><img src="images//photo-white-03.jpeg" style="float:right;width:180px;" alt=white plate example>
...
Tap on the camera icon in the bottom right corner to go into Camera mode. This may pop up a permissions box asking if you want to give the app access to your location to tag the data within the photo. This option is up to you. 
To the left of the shutter release button, tap on the drop down menu. This should have options for Automatic, Professional, and High Dynamic Range. Select Professional. 
...
Aim at the object you want to take a photo of, tap on Exp and drag the slider to the left or right to adjust the Exposure if you need more or less light for this photo. Tap on the object to focus on it. If you want to lock focus and recompose, you can tap and hold.
When satisfied, tap the shutter release button to take the photo.
